  ...
  public void play (Napakalaki aGame, int numberOfPlayers) {
    ...
    do { // Mientras dure la partida
      ...
      do { // Mientras el jugador se decide a conocer al monstruo
        System.out.println ("******* ******* ******* ******* ******* ******* *******");
        System.out.println ("\n\n Turno de: " + currentPlayer.toString() + "          Enemigo: " + currentPlayer.getEnemy().toString());
        System.out.println ("\n\n******* ******* ******* ******* ******* ******* *******");
        System.out.println ("\nNivel: "+currentPlayer.getLevels());
        System.out.println ("\nNivel de Combate : "+currentPlayer.getCombatLevel());
    ...
    switch (command) {
      ...
      case NextTurn :
        if (! game.nextTurn ()) {
          ...
          System.out.println ("\n\nTienes que cumplir el siguiente mal rollo");
          System.out.println (aPlayer.getPendingBadConsequence().toString());
        } else {
