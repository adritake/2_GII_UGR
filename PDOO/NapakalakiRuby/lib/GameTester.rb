  ...
  def play(aGame, numberOfPlayers)
    ...
    begin #Mientras dure la partida
      ...
      begin #Mientras el jugador se decide a conocer al monstruo
        puts "******* ******* ******* ******* ******* ******* *******"
        puts "\n\n Turno de: " + currentPlayer.to_s() + "               Enemigo:" + currentPlayer.enemy.to_s
        puts "\n\n******* ******* ******* ******* ******* ******* *******"
        puts "\nNivel: " + currentPlayer.getLevels.to_s
        puts "\nNivel de combate: "+currentPlayer.getCombatLevel.to_s
...
#        gets
      ...
      when Command::NextTurn then
        if ! @game.nextTurn() then
          ...
          puts "Tienes que cumplir el siguiente malrollo:"
          puts aPlayer.pendingBadConsequence.to_s
        else 
